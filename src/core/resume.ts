...
export function CompareDateRangeAscending(
  first: DateRange,
  second: DateRange
): number {
...
export function CompareDateRangeDescending(
  first: DateRange,
  second: DateRange
): number {
...
export function SortEntitiesDescending(entities: EntityInvolvements[]): void {
  ...
  entities.sort((a, b) => {
    ...
    return CompareDateRangeDescending(
      a.involvements[0].dates,
      b.involvements[0].dates
    );
  });
}
